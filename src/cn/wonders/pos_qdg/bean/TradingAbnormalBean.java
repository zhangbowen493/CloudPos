 ...
 *	用于处理异常情况的交易流水
 */
@DatabaseTable(tableName = "tb_abnormal_list")
public class TradingAbnormalBean {
	
	public TradingAbnormalBean() {
		super();
	}
	public TradingAbnormalBean(TradingBean bean) {
		super();
		setTradingBean(bean);
	}
	//id
...
// ---=90=00=	状态位
	...
	public String toString() {
		return "AbnormalTradingBean [id=" + id + ", WorkerID=" + WorkerID
