...
import com.j256.ormlite.table.DatabaseTable;
	 ...
	 *
	 */
@DatabaseTable(tableName = "tb_tran_list")
public class TradingBean {
	/** 交易流水解析出错**/
	public static final String abnormal_parsing_trading_error = "PTE";
	/** 存交易流水出错**/
	public static final String abnormal_save_trading_error = "STE";
	/** 上送银联成功 更新数据库出错**/
	public static final String abnormal_update_erroe = "UTE";
...
// ---=90=00=	状态位
	...
	public String toString() {
		return "TradingBean [id=" + id + ", WorkerID=" + WorkerID
	...
	public int getEC_Blance(){
		if (Card_IDD_V.length()>=30) {
			return Integer.parseInt(Card_IDD_V.subSequence(20, 30).toString());
		}
		return 0;
	}
