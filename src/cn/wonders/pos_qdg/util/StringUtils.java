...
public class StringUtils {
	...
	public static boolean isEquals(String actual, String expected) {
		return Arith.isEquals(actual, expected);
	}
...
/**
	...
	public static boolean checkHexNum(String a) {
		for (int i = 0; i < a.length(); i++) {
			// 与'0'和'9'比较，不是0,9.
			if (a.charAt(i) >= '0' && a.charAt(i) <= '9' || a.charAt(i) >= 'a'
					&& a.charAt(i) <= 'f' || a.charAt(i) >= 'A'
					&& a.charAt(i) <= 'F') {
				continue;
			} else {
				return false;
