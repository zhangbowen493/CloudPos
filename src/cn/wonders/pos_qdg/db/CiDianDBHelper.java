 ...
 */
public class CiDianDBHelper extends OrmLiteSqliteOpenHelper {
	
	private static final String TABLE_NAME = "sqlite_cidian.db";
	
	private Map<String, Dao> daos = new HashMap<String, Dao>();
	
	private static CiDianDBHelper instance;
	
	
	private CiDianDBHelper(Context context)
	{
	 ...
	 * @return
	 */
	public static synchronized CiDianDBHelper getHelper(Context context)
	{
		...
		if (instance == null)
		{
			...
			{
				if (instance == null)
					instance = new CiDianDBHelper(context);
			}
		}
...
//	}
	...
	public void onCreate(SQLiteDatabase database,
		...
		try
		{
			TableUtils.createTable(connectionSource, CiDianBean.class);
	...
	public void onUpgrade(SQLiteDatabase database,
		...
		try
		{
			TableUtils.dropTable(connectionSource, CiDianBean.class, true);
