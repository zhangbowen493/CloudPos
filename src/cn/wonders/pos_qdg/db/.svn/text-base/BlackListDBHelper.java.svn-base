 ...
 */
public class BlackListDBHelper extends OrmLiteSqliteOpenHelper {
	
	private static final String TABLE_NAME = "sqlite-pos_black.db";
	 ...
	 * @return
	 */
	public static synchronized BlackListDBHelper getHelper(Context context)
	{
		...
		if (instance == null)
		{
			...
			{
				if (instance == null)
					instance = new BlackListDBHelper(context);
			}
		}
