 ...
 */
public class QuotaRateDBHelper extends OrmLiteSqliteOpenHelper {
	
	private static final String TABLE_NAME = "pos_quota_rate.db";
	
	private Map<String, Dao> daos = new HashMap<String, Dao>();
	
	private static QuotaRateDBHelper instance;
	
	
	private QuotaRateDBHelper(Context context)
	{
	 ...
	 * @return
	 */
	public static synchronized QuotaRateDBHelper getHelper(Context context)
	{
		...
		if (instance == null)
		{
			...
			{
				if (instance == null)
					instance = new QuotaRateDBHelper(context);
			}
		}
...
//	}
	...
	public void onCreate(SQLiteDatabase database,
		...
		try
		{
			TableUtils.createTable(connectionSource, QuotaRate.class);
	...
	public void onUpgrade(SQLiteDatabase database,
		...
		try
		{
			TableUtils.dropTable(connectionSource, QuotaRate.class, true);
